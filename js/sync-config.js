(function(){
  ...
  const C = ROOT.config = Object.freeze({
    ...
    PROGRESS_SYNC_MODEL: 'lineage-v2',
    HISTORY_FILE: `${CLOUD_CONFIG.driveFilePrefix}.progress-history.json`,
    HISTORY_TYPE: 'exam-simulator2-progress-history',
    HISTORY_SCHEMA_VERSION: 1,
    SNAPSHOT_TYPE: 'exam-simulator2-progress-snapshot',
